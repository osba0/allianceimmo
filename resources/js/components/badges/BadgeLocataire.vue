<template>
  <div class="badge-container">
    <!-- RECTO -->
    <div class="badgeImprimable badge-recto">
      <div class="accroche"></div>
      <div class="logoAgenceBadge">
      ...
      <img class="photo" :src="photo" alt="Photo locataire" />
      <div class="infos-badge">
        <h3><strong>{{ locataire.nom }} {{ locataire.prenom }}</strong></h3>
        <p><strong>IDENTIFIANT :</strong> {{ locataire.id }}</p>
        <p><strong>Tél :</strong> {{ locataire.telephone }}</p>
        <p><strong>Email :</strong> {{ locataire.email }}</p>
      </div>
    </div>

    <!-- VERSO -->
    <div class="badgeImprimable badge-verso">
      <div class="accroche"></div>
...
.badge-recto .logoAgenceBadge{
  position: absolute;
  top: 10px;
  left: 10px;
}

.badge-recto .logoAgenceBadge img{
  width: 80px;
  height: auto;
}
