<template>
    <div>
        <div class="d-flex justify-content-between mb-3">
            ...
            <button type="button" class="btn btn-lg btn-primary" data-toggle="modal" data-target="#addNew" v-on:click="newModal" ><i class="fa fa-plus-square"></i> Nouveau Mandat de Gérance</button>
        </div>
