        ...
        <div class="modal fade" id="addNew" data-backdrop="static" data-keyboard="false" tabindex="-1"  role="dialog" aria-labelledby="addNew" aria-hidden="true">
            ...
            <div class="modal-dialog modal-xl position-relative" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title text-uppercase" v-show="!editmode"><strong><span class="text-primary"><u>Ajout</u></span> Opération</strong></h5>
...
export default {
    ...
    methods: {
        getOperations(page=1){
           this.isLoading = true;
            axios.get("/operations/listing?paginate="+this.paginate+'&page=' + page).then(responses => {
