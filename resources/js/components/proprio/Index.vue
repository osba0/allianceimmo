    ...
    <div>
        <template v-if="!viewRepresentant">
            <div class="d-flex justify-content-between mb-3">
                ...
                <button type="button" class="btn btn-lg btn-primary" data-toggle="modal" data-target="#addNew" v-on:click="newModal" ><i class="fa fa-plus"></i> Nouveau Propriétaire</button>
            </div>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex justify-content-between">
                                           <div class="form-group w-49">
                                                <label>Nationalié</label>
                                                <input v-model="form.nationalite" type="text"
                                                    class="form-control" :class="{ 'border-danger': isSubmitted && !$v.form.nationalite.required }">
                                            </div>
