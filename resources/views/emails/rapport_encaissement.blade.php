...
<body>
  ...
  <div class="header">
    <h2 style="background: rgb(38, 50, 77); color: white; text-align: center; padding: 4px 0">📄 DETAILS ENCAISSEMENTS LOYERS</h2>
  </div>
  <div style="padding: 0 25px;">
    ...
    <p>Nous vous informons que votre <strong>rapport d’encaissement de loyer</strong> couvrant la période du <strong>{{ $dateDebut }}</strong> au <strong>{{ $dateFin }}</strong> est disponible.</p>
    ...
    <p>Ce document contient les détails des encaissements perçus pour vos biens mis en location.</p>
