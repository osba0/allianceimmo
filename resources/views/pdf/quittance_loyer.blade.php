                ...
                <tr>
                    ...
                    <td style="text-align:center;padding-top:10px;">
                        ...
                        <table class="numero" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr><td><td><span style="color: red">N°</span> {{ $paiement_id }}</td></tr>
                            <tr><td height="5"></td></tr>
                        </table>
                    </td>
                </tr>
    ...
    <table class="table" border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
            <tr>
                ...
                $loyerPrincipal = ceil(($local['local_prix_loyer'] - $local['local_montant_charge']) * 100 / (100 + $local['local_tom'] + $local['local_tlv'] + $local['local_tva'] + $local['local_timbre'] + $local['local_eau_forfait']));

                @endphp
                <td align="center" width="13%">{{ $loyerPrincipal }} F</td>
                <td align="center" width="12%">{{ ceil($loyerPrincipal * $local['local_tom'] / 100) }} F</td>
                <td align="center" width="12%">{{ ceil($loyerPrincipal * $local['local_tlv'] / 100) }} F</td>
                <td align="center" width="12%">{{ ceil($loyerPrincipal * $local['local_tva'] / 100) }} F</td>
                <td align="center" width="14%">{{ ceil($local['local_montant_charge']) }} F</td>
                <td align="center" width="12%">{{ ceil($local['local_eau_forfait']) }} F</td>
                <td align="center" width="12%">{{ ceil($local['local_timbre']) }} F</td>
                <td align="center" width="13%" class="border-right">{{ ceil($local['local_prix_loyer']) }} F</td>
                @endforeach
            </tr>
        </tbody>
    </table>
        ...
        <tbody>
            ...
            <tr>
             ...
             <tr>
                ...
                <td width="3%">:</td>
                <td>{{ $bail_montant_ht }} F {!! numberToLetter($bail_montant_ht) !!})</td>
            </tr>
            <tr>
